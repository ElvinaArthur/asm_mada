"use strict";(()=>{var e={};e.id=5672,e.ids=[5672],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},78893:e=>{e.exports=require("buffer")},84770:e=>{e.exports=require("crypto")},17702:e=>{e.exports=require("events")},92048:e=>{e.exports=require("fs")},32615:e=>{e.exports=require("http")},35240:e=>{e.exports=require("https")},98216:e=>{e.exports=require("net")},19801:e=>{e.exports=require("os")},55315:e=>{e.exports=require("path")},76162:e=>{e.exports=require("stream")},82452:e=>{e.exports=require("tls")},17360:e=>{e.exports=require("url")},21764:e=>{e.exports=require("util")},71568:e=>{e.exports=require("zlib")},72254:e=>{e.exports=require("node:buffer")},6005:e=>{e.exports=require("node:crypto")},47261:e=>{e.exports=require("node:util")},91336:(e,t,s)=>{s.r(t),s.d(t,{originalPathname:()=>p,patchFetch:()=>c,requestAsyncStorage:()=>A,routeModule:()=>N,serverHooks:()=>L,staticGenerationAsyncStorage:()=>I});var r={};s.r(r),s.d(r,{GET:()=>n,POST:()=>d});var E=s(49303),T=s(88716),i=s(60670),a=s(87070),o=s(75748),u=s(95456);async function n(e){let t=await (0,u.nX)(e);if(!t)return a.NextResponse.json({success:!1,message:"Non autoris\xe9"},{status:401});let s=await (0,o.sql)`
    SELECT ue.*, e.title, e.date, e.location, e."imageUrl"
    FROM user_events ue JOIN events e ON ue."eventId" = e.id
    WHERE ue."userId" = ${t.id} ORDER BY e.date DESC
  `;return a.NextResponse.json({success:!0,data:s.rows})}async function d(e){let t=await (0,u.nX)(e);if(!t)return a.NextResponse.json({success:!1,message:"Non autoris\xe9"},{status:401});let{eventId:s}=await e.json();if(!s)return a.NextResponse.json({success:!1,message:"eventId requis"},{status:400});try{let e=await (0,o.sql)`
      INSERT INTO user_events ("userId", "eventId", status) VALUES (${t.id}, ${s}, 'registered')
      ON CONFLICT ("userId", "eventId") DO NOTHING RETURNING *
    `;return a.NextResponse.json({success:!0,data:e.rows[0]},{status:201})}catch{return a.NextResponse.json({success:!1,message:"Erreur serveur"},{status:500})}}let N=new E.AppRouteRouteModule({definition:{kind:T.x.APP_ROUTE,page:"/api/user/events/route",pathname:"/api/user/events",filename:"route",bundlePath:"app/api/user/events/route"},resolvedPagePath:"C:\\Users\\Rasoa\\Desktop\\ASM\\frontend\\app\\api\\user\\events\\route.ts",nextConfigOutput:"",userland:r}),{requestAsyncStorage:A,staticGenerationAsyncStorage:I,serverHooks:L}=N,p="/api/user/events/route";function c(){return(0,i.patchFetch)({serverHooks:L,staticGenerationAsyncStorage:I})}},95456:(e,t,s)=>{s.d(t,{fT:()=>i,kF:()=>u,nX:()=>o});var r=s(6091),E=s(6176);let T=new TextEncoder().encode(process.env.JWT_SECRET||"asm-alumni-secret-key-change-in-production");async function i(e){return await new r.N(e).setProtectedHeader({alg:"HS256"}).setIssuedAt().setExpirationTime("30d").sign(T)}async function a(e){try{let{payload:t}=await (0,E._)(e,T);return t}catch{return null}}async function o(e){let t=e.headers.get("authorization");if(!t?.startsWith("Bearer "))return null;let r=t.slice(7),E=await a(r);if(!E)return null;let{sql:T}=await Promise.resolve().then(s.bind(s,75748)),i=await T`
...
`}};var t=require("../../../../webpack-runtime.js");t.C(e);var s=e=>t(t.s=e),r=t.X(0,[9276,5972,509],()=>s(91336));module.exports=r})();