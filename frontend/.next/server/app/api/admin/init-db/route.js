"use strict";(()=>{var e={};e.id=9773,e.ids=[9773],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},78893:e=>{e.exports=require("buffer")},84770:e=>{e.exports=require("crypto")},17702:e=>{e.exports=require("events")},92048:e=>{e.exports=require("fs")},32615:e=>{e.exports=require("http")},35240:e=>{e.exports=require("https")},98216:e=>{e.exports=require("net")},19801:e=>{e.exports=require("os")},55315:e=>{e.exports=require("path")},76162:e=>{e.exports=require("stream")},82452:e=>{e.exports=require("tls")},17360:e=>{e.exports=require("url")},21764:e=>{e.exports=require("util")},71568:e=>{e.exports=require("zlib")},72254:e=>{e.exports=require("node:buffer")},6005:e=>{e.exports=require("node:crypto")},47261:e=>{e.exports=require("node:util")},54332:(e,t,E)=>{E.r(t),E.d(t,{originalPathname:()=>L,patchFetch:()=>p,requestAsyncStorage:()=>u,routeModule:()=>N,serverHooks:()=>I,staticGenerationAsyncStorage:()=>A});var r={};E.r(r),E.d(r,{POST:()=>n});var T=E(49303),s=E(88716),i=E(60670),a=E(87070),o=E(75748),d=E(95456);async function n(e){let t=await (0,d.nX)(e),E=(0,d.kF)(t);if(E)return a.NextResponse.json(E.body,{status:E.status});try{for(let e of o.l.split(";").filter(e=>e.trim()))e.trim()&&await o.sql.query(e);return a.NextResponse.json({success:!0,message:"Base de donn\xe9es initialis\xe9e"})}catch(e){return console.error("DB init error:",e),a.NextResponse.json({success:!1,message:"Erreur d'initialisation"},{status:500})}}let N=new T.AppRouteRouteModule({definition:{kind:s.x.APP_ROUTE,page:"/api/admin/init-db/route",pathname:"/api/admin/init-db",filename:"route",bundlePath:"app/api/admin/init-db/route"},resolvedPagePath:"C:\\Users\\Rasoa\\Desktop\\ASM\\frontend\\app\\api\\admin\\init-db\\route.ts",nextConfigOutput:"",userland:r}),{requestAsyncStorage:u,staticGenerationAsyncStorage:A,serverHooks:I}=N,L="/api/admin/init-db/route";function p(){return(0,i.patchFetch)({serverHooks:I,staticGenerationAsyncStorage:A})}},95456:(e,t,E)=>{E.d(t,{fT:()=>i,kF:()=>d,nX:()=>o});var r=E(6091),T=E(6176);let s=new TextEncoder().encode(process.env.JWT_SECRET||"asm-alumni-secret-key-change-in-production");async function i(e){return await new r.N(e).setProtectedHeader({alg:"HS256"}).setIssuedAt().setExpirationTime("30d").sign(s)}async function a(e){try{let{payload:t}=await (0,T._)(e,s);return t}catch{return null}}async function o(e){let t=e.headers.get("authorization");if(!t?.startsWith("Bearer "))return null;let r=t.slice(7),T=await a(r);if(!T)return null;let{sql:s}=await Promise.resolve().then(E.bind(E,75748)),i=await s`
...
`}};var t=require("../../../../webpack-runtime.js");t.C(e);var E=e=>t(t.s=e),r=t.X(0,[9276,5972,509],()=>E(54332));module.exports=r})();